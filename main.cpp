...
int main()
{
	...
	// set the current window and assign a resize callback function
	...
	// -- GRAPHICS --
	// build and compile the vertex and fragment shaders.
	...
	for (int y = 0; y < height; y++)
	{
		for (int z = 0; z < depth; z++)
		{
			...
			{
				cubePositions[(width * depth) * y + z * width + x] = glm::vec3((float)x, (float)-y, (float)z);
			}
		}
	}
	...
	// position attribute pointer for light source.
	glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, 8 * sizeof(float), (void*)0);
	glEnableVertexAttribArray(0);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// use 'GL_LINE' to enable wireframe mode
		...
		*/
		...
		lightingShader.setVec3("directionalLight.ambient", 1.0f, 1.0f, 1.0f);
		lightingShader.setVec3("directionalLight.diffuse", 1.0f, 1.0f, 1.0f);
	...
	// let GLFW clean up all created assets
	glfwTerminate();
	return 0;
}

/// resize the viewport whenever the window gets resized
void framebuffer_size_callback(GLFWwindow* window, int width, int height)
{
